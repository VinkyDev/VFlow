...
local CHANGELOG = {
	{
		...
		date = "2026-06-05",
		content = {
			"新增其他BUFF代替计时BUFF，额外支持被动BUFF监控（如被动饰品）",
			"修复若干BUG",
		}
	},
	{
		...
		date = "2026-05-11",
		content = {
			-- "5.23 hotfix-1: 修复额外CD组追加后样式异常BUG, 修复BUFF持续时间遮罩层颜色设置不生效BUG",
			"性能大幅优化, CPU占用显著降低",
			"原自定义播报和自定义高亮设置移动到了技能和BUFF的设置中",
			"支持指定技能移除增益遮罩层",
			"模块化改造, 支持开关具体模块, 将不需要的功能完全卸载",
			"物品BUFF组升级为计时BUFF组, 支持技能计时BUFF监控",
			"狂暴战新增次要资源条旋风斩",
			"文字描边支持单色像素描边"
		},
	},
